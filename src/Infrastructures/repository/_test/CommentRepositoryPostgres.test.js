...
const CommentLikesTableTestHelper = require('../../../../tests/CommentLikesTableTestHelper'); // Import helper baru
...
describe('CommentRepositoryPostgres', () => {
  afterEach(async () => {
    await CommentLikesTableTestHelper.cleanTable(); // Tambahkan pembersihan tabel likes
  ...
  describe('getCommentsByThreadId function', () => {
    it('should return thread comments correctly including like_count', async () => {
      ...
      // Tambahkan satu like untuk komentar tersebut
      ...
      expect(comments[0]).toStrictEqual({
        ...
        like_count: 1, // Pastikan like_count terhitung
      });
    });
  ...
  /**
   * PENGUJIAN BARU: Fungsi terkait Like
   */
